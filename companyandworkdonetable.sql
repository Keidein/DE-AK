...
((workDoneID), "Water Lilies", "Oscar-Claude Monet was a French painter, a founder of French Impressionist painting and the most consistent and prolific practitioner
    ...
    later in the series of large-scale paintings that was to occupy him continuously for the next 20 years of his life.", "", "", "", "", "Arts"),
((workDoneID), "", "Leonardo di ser Piero da Vinci, more commonly Leonardo da Vinci, was an Italian polymath of the Renaissance, 
    ...
    Sometimes credited with the inventions of the parachute, helicopter and tank, he epitomised the Renaissance humanist ideal.","","","", "", "Arts"),
((workDoneID), "", "The Mona Lisa is a half-length portrait painting by the Italian Renaissance artist 
    ...
    which is worth nearly $800 million in 2017.", "1503-1506", "Oil on poplar panel", "77cm x53 cm", "Musee du Louvre, Paris","Arts"),
((workDoneID), "", "In mathematics, the Pythagorean theorem, also known as Pythagoras' theorem, 
    ...
    popular references in literature, plays, musicals, songs, stamps and cartoons abound.", "", "", "", "", "Mathematics"),
((workDoneID), "", "Euclid, sometimes given the name Euclid of Alexandria to distinguish him from Euclides of Megara, 
	...
	Euclid also wrote works on perspective, conic sections, spherical geometry, number theory, and rigor.", "", "", "", "", "Mathematics"),
((workDoneID), "", "Quicksort (sometimes called partition-exchange sort) is an efficient sorting algorithm, 
    ...
    It is very similar to selection sort, except that it does not always choose worst-case partition.", "", "", "", "", "Mathematics"),
 ((workDoneID), "", "William Henry Gates III is an American business magnate, investor, author, philanthropist, humanitarian, 
	...
	but he remained as chairman and created the position of chief software architect for himself.", "", "", "", "", "Technology"),
((workDoneID), "", "Steven Paul Jobs was an American entrepreneur and business magnate. 
	...
	along with Apple co-founder Steve Wozniak.", "", "", "", "", "Technology"),
((workDoneID), "", "Java is a general-purpose computer-programming language that is concurrent, class-based, object-oriented, 
	...
	The language derives much of its syntax from C and C++, but it has fewer low-level facilities than either of them.", "", "", "", "", "Technology");
