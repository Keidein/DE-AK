...
insert into company
	values 
    ((companyID),"Sun microsystem","James gosling");
    
insert into workDone
	values 
((workDoneID), "Water Lilies", "Oscar-Claude Monet was a French painter, a founder of French Impressionist painting and the most consistent and prolific practitioner
    ...
    later in the series of large-scale paintings that was to occupy him continuously for the next 20 years of his life.", NULL, NULL, NULL, NULL, 1, 1, NULL),
((workDoneID), NULL, "Leonardo di ser Piero da Vinci, more commonly Leonardo da Vinci, was an Italian polymath of the Renaissance, 
    ...
    Sometimes credited with the inventions of the parachute, helicopter and tank, he epitomised the Renaissance humanist ideal.",NULL,NULL,NULL, NULL, 2, 1, NULL),
((workDoneID), NULL, "The Mona Lisa is a half-length portrait painting by the Italian Renaissance artist 
    ...
    which is worth nearly $800 million in 2017.", "1503-1506", "Oil on poplar panel", "77cm x53 cm", "Musee du Louvre, Paris", 3, 2, NULL),
((workDoneID), NULL, "In mathematics, the Pythagorean theorem, also known as Pythagoras' theorem, 
    ...
    popular references in literature, plays, musicals, songs, stamps and cartoons abound.", NULL, NULL, NULL, NULL, 4, 3, NULL),
((workDoneID), NULL, "Euclid, sometimes given the name Euclid of Alexandria to distinguish him from Euclides of Megara, 
	...
	Euclid also wrote works on perspective, conic sections, spherical geometry, number theory, and rigor.", NULL, NULL, NULL, NULL, 5, 5, NULL),
((workDoneID), NULL, "Quicksort (sometimes called partition-exchange sort) is an efficient sorting algorithm, 
    ...
    It is very similar to selection sort, except that it does not always choose worst-case partition.", NULL, NULL, NULL, NULL, 6, 6, 1),
 ((workDoneID), NULL, "William Henry Gates III is an American business magnate, investor, author, philanthropist, humanitarian, 
	...
	but he remained as chairman and created the position of chief software architect for himself.", NULL, NULL, NULL, NULL, 7, 5, NULL),
((workDoneID), NULL, "Steven Paul Jobs was an American entrepreneur and business magnate.
	...
	along with Apple co-founder Steve Wozniak.", NULL, NULL, NULL, NULL, 8, 8, NULL),
((workDoneID), NULL, "Java is a general-purpose computer-programming language that is concurrent, class-based, object-oriented, 
